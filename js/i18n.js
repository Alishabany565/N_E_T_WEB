(() => {
  ...
  const dict = {
    en: {
      ...
      emptyPredictionMsg: "Add expenses to see predictions.",
      emptyInsightsMsg: "Add expenses to see insights.",
      ...
      heatmapSubtitle: "Darker day = lower spending",
      heatmapLess: "Less",
      heatmapMore: "More",
    ...
    ar: {
      ...
      emptyPredictionMsg: "أضف مصروفات لرؤية التوقعات.",
      emptyInsightsMsg: "أضف مصروفات لرؤية التحليلات.",
      ...
      heatmapSubtitle: "اليوم الأغمق يعني إنفاقًا أقل",
      heatmapLess: "أقل",
      heatmapMore: "أكثر",
    ...
    he: {
      ...
      emptyPredictionMsg: "הוסף הוצאות כדי לראות תחזיות.",
      emptyInsightsMsg: "הוסף הוצאות כדי לראות תובנות.",
      ...
      heatmapSubtitle: "יום כהה יותר = הוצאה נמוכה יותר",
      heatmapLess: "פחות",
      heatmapMore: "יותר",
